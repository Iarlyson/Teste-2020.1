...
import br.edu.ifpb.testes.carrinho.contato.Produto;
...
public class CarrinhoImplTest {
    ...
    private CadastroImpl carrinhoImpl;
    ...
    public void prepararCenario() {
        ...
        this.carrinhoImpl = new CadastroImpl(estoque);
    }

    @Test
    public void inserirProduto() throws ContatoForadeBancoException {
    ...
    @Test
    public void removerProduto() throws ContatoForadeBancoException {
        // Realizar o estímulo ao sistema
        Produto produto = new Produto(1, "Mouse", 17L);
        carrinhoImpl.adicionarItem(produto);
    ...
    @Test
    public void testarTotal() throws ContatoForadeBancoException {
        // Realizar o estímulo ao sistema
    ...
    @Test
    public void testarTotalComDescontoComprasAcima4() throws ContatoForadeBancoException {
    ...
    @Test
    public void adicionarItemComEstoque() throws ContatoForadeBancoException {
        // Realizar o estímulo ao sistema
        Produto produto1 = new Produto(1, "Mouse", 50L);
        carrinhoImpl.adicionarItem(produto1);
        Assert.assertEquals(1, carrinhoImpl.getQtdeItens());
    ...
    public void adicionarItemSemEstoque() throws ContatoForadeBancoException {
